...
// Note: This file is taken directly from github.com/mozilla-services/pkcs7,
// and is MIT licensed.
...
type asn1Object interface {
	EncodeTo(writer *bytes.Buffer, encodeIndent *int) error
}
...
func (s asn1Structured) EncodeTo(out *bytes.Buffer, encodeIndent *int) error {
	//fmt.Printf("%s--> tag: % X\n", strings.Repeat("| ", encodeIndent), s.tagBytes)
	*encodeIndent++
	inner := new(bytes.Buffer)
	for _, obj := range s.content {
		err := obj.EncodeTo(inner, encodeIndent)
		if err != nil {
			return err
		}
	}
...
func (p asn1Primitive) EncodeTo(out *bytes.Buffer, _ *int) error {
