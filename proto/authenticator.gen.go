// sequence-waas-authenticator v0.1.0 0e207dba0750822dd4f067f67ab90fe03aec7f1e
// --
...
func WebRPCSchemaHash() string {
	return "0e207dba0750822dd4f067f67ab90fe03aec7f1e"
}
...
type WaasAuthenticator interface {
	RegisterSessionV1(ctx context.Context, intent *Intent, friendlyName string) (*Session, interface{}, error)
	SendIntentV1(ctx context.Context, intent *Intent) (string, interface{}, error)
...
func (s *waasAuthenticatorServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	switch r.URL.Path {
	case "/rpc/WaasAuthenticator/RegisterSessionV1":
		handler = s.serveRegisterSessionV1JSON
	case "/rpc/WaasAuthenticator/SendIntentV1":
		handler = s.serveSendIntentV1JSON
...
func (s *waasAuthenticatorServer) serveRegisterSessionV1JSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "RegisterSessionV1")
	...
	ret0, ret1, err := s.WaasAuthenticator.RegisterSessionV1(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
...
func (s *waasAuthenticatorServer) serveSendIntentV1JSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "SendIntentV1")
	...
	// Call service method implementation.
	ret0, ret1, err := s.WaasAuthenticator.SendIntentV1(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (c *waasAuthenticatorClient) RegisterSessionV1(ctx context.Context, intent *Intent, friendlyName string) (*Session, interface{}, error) {
	in := struct {
		Arg0 *Intent `json:"intent"`
		Arg1 string  `json:"friendlyName"`
	}{intent, friendlyName}
...
func (c *waasAuthenticatorClient) SendIntentV1(ctx context.Context, intent *Intent) (string, interface{}, error) {
	in := struct {
		Arg0 *Intent `json:"intent"`
	}{intent}
	out := struct {
