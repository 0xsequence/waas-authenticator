// sequence-waas-authenticator v0.1.0 44b896fb36925560b5dab6af21286e38ccc52951
// --
...
func WebRPCSchemaHash() string {
	return "44b896fb36925560b5dab6af21286e38ccc52951"
}
...
const (
	Migration_OIDCToStytch Migration = "OIDCToStytch"
	Migration_OIDCToEmail  Migration = "OIDCToEmail"
)

func (x Migration) MarshalText() ([]byte, error) {
	return []byte(x), nil
}

func (x *Migration) UnmarshalText(b []byte) error {
	*x = Migration(string(b))
	return nil
}

func (x *Migration) Is(values ...Migration) bool {
	if x == nil {
		return false
	}
	for _, v := range values {
...
type AuthConfig struct {
	...
	Twitter AuthTwitterConfig `json:"twitter,omitempty"`
}
...
type WaasAuthenticatorAdmin interface {
	...
	NextMigrationBatch(ctx context.Context, migration Migration, projectId uint64, page *Page) (*Page, []string, error)
	ProcessMigrationBatch(ctx context.Context, migration Migration, projectId uint64, items []string) (map[string][]string, map[string]string, error)
}
...
func (s *waasAuthenticatorAdminServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/WaasAuthenticatorAdmin/NextMigrationBatch":
		handler = s.serveNextMigrationBatchJSON
	case "/rpc/WaasAuthenticatorAdmin/ProcessMigrationBatch":
		handler = s.serveProcessMigrationBatchJSON
	default:
		err := ErrWebrpcBadRoute.WithCause(fmt.Errorf("no handler for path %q", r.URL.Path))
		s.sendErrorJSON(w, r, err)
		return
...
func (s *waasAuthenticatorAdminServer) serveNextMigrationBatchJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "NextMigrationBatch")
	...
	// Call service method implementation.
	ret0, ret1, err := s.WaasAuthenticatorAdmin.NextMigrationBatch(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *waasAuthenticatorAdminServer) serveProcessMigrationBatchJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ProcessMigrationBatch")
	...
	// Call service method implementation.
	ret0, ret1, err := s.WaasAuthenticatorAdmin.ProcessMigrationBatch(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
	...
	respPayload := struct {
		Ret0 map[string][]string `json:"logs"`
...
func NewWaasAuthenticatorAdminClient(addr string, client HTTPClient) WaasAuthenticatorAdminClient {
	...
	urls := [8]string{
		...
		prefix + "CreateTenant",
		prefix + "UpdateTenant",
		prefix + "NextMigrationBatch",
		prefix + "ProcessMigrationBatch",
	}
...
func (c *waasAuthenticatorAdminClient) NextMigrationBatch(ctx context.Context, migration Migration, projectId uint64, page *Page) (*Page, []string, error) {
	in := struct {
		Arg0 Migration `json:"migration"`
		Arg1 uint64    `json:"projectId"`
		Arg2 *Page     `json:"page"`
	}{migration, projectId, page}
	out := struct {
		Ret0 *Page    `json:"page"`
		Ret1 []string `json:"items"`
	}{}
...
func (c *waasAuthenticatorAdminClient) ProcessMigrationBatch(ctx context.Context, migration Migration, projectId uint64, items []string) (map[string][]string, map[string]string, error) {
	in := struct {
		Arg0 Migration `json:"migration"`
		Arg1 uint64    `json:"projectId"`
		Arg2 []string  `json:"items"`
	}{migration, projectId, items}
	out := struct {
		Ret0 map[string][]string `json:"logs"`
		Ret1 map[string]string   `json:"errors"`
	}{}
