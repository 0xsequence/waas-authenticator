...
func WebRPCSchemaHash() string {
	return "12981425046f42285c75880877768ce81be8b3f9"
}
...
var (
	...
	ErrAccountAlreadyLinked    = WebRPCError{Code: 2001, Name: "AccountAlreadyLinked", Message: "Could not link account as it is linked to another wallet", HTTPStatus: 409}
	ErrProofVerificationFailed = WebRPCError{Code: 2002, Name: "ProofVerificationFailed", Message: "The authentication proof could not be verified", HTTPStatus: 400}
	ErrAnswerIncorrect         = WebRPCError{Code: 2003, Name: "AnswerIncorrect", Message: "The provided answer is incorrect", HTTPStatus: 400}
	ErrChallengeExpired        = WebRPCError{Code: 2004, Name: "ChallengeExpired", Message: "The challenge has expired", HTTPStatus: 400}
)
