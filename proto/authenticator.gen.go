// sequence-waas-authenticator v0.1.0 23df6aafb172e24df64c2c36181ab8801219c0c5
// --
...
func WebRPCSchemaHash() string {
	return "23df6aafb172e24df64c2c36181ab8801219c0c5"
}
...
type WaasAuthenticatorV1 interface {
...
type waasAuthenticatorV1Server struct {
	WaasAuthenticatorV1
	OnError func(r *http.Request, rpcErr *WebRPCError)
}

func NewWaasAuthenticatorV1Server(svc WaasAuthenticatorV1) *waasAuthenticatorV1Server {
	return &waasAuthenticatorV1Server{
		WaasAuthenticatorV1: svc,
	}
}

func (s *waasAuthenticatorV1Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	defer func() {
		// In case of a panic, serve a HTTP 500 error and then panic.
		if rr := recover(); rr != nil {
			s.sendErrorJSON(w, r, ErrWebrpcServerPanic.WithCause(fmt.Errorf("%v", rr)))
	...
	ctx = context.WithValue(ctx, HTTPResponseWriterCtxKey, w)
	ctx = context.WithValue(ctx, HTTPRequestCtxKey, r)
	ctx = context.WithValue(ctx, ServiceNameCtxKey, "WaasAuthenticatorV1")

	var handler func(ctx context.Context, w http.ResponseWriter, r *http.Request)
	switch r.URL.Path {
	case "/rpc/WaasAuthenticatorV1/RegisterSession":
		handler = s.serveRegisterSessionJSON
	case "/rpc/WaasAuthenticatorV1/SendIntent":
		handler = s.serveSendIntentJSON
	case "/rpc/WaasAuthenticatorV1/ChainList":
		handler = s.serveChainListJSON
	default:
		err := ErrWebrpcBadRoute.WithCause(fmt.Errorf("no handler for path %q", r.URL.Path))
		s.sendErrorJSON(w, r, err)
...
func (s *waasAuthenticatorV1Server) serveRegisterSessionJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "RegisterSession")
	...
	// Call service method implementation.
	ret0, ret1, err := s.WaasAuthenticatorV1.RegisterSession(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *waasAuthenticatorV1Server) serveSendIntentJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "SendIntent")
	...
	// Call service method implementation.
	ret0, ret1, err := s.WaasAuthenticatorV1.SendIntent(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *waasAuthenticatorV1Server) serveChainListJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ChainList")

	// Call service method implementation.
	ret0, err := s.WaasAuthenticatorV1.ChainList(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *waasAuthenticatorV1Server) sendErrorJSON(w http.ResponseWriter, r *http.Request, rpcErr WebRPCError) {
	if s.OnError != nil {
		s.OnError(r, &rpcErr)
	}
...
const WaasAuthenticatorV1PathPrefix = "/rpc/WaasAuthenticatorV1/"
...
type waasAuthenticatorV1Client struct {
	client HTTPClient
	urls   [3]string
}

func NewWaasAuthenticatorV1Client(addr string, client HTTPClient) WaasAuthenticatorV1 {
	prefix := urlBase(addr) + WaasAuthenticatorV1PathPrefix
	urls := [3]string{
		prefix + "RegisterSession",
		prefix + "SendIntent",
		prefix + "ChainList",
	}
	return &waasAuthenticatorV1Client{
		client: client,
		urls:   urls,
	}
}

func (c *waasAuthenticatorV1Client) RegisterSession(ctx context.Context, intent *Intent, friendlyName string) (*Session, interface{}, error) {
	in := struct {
		Arg0 *Intent `json:"intent"`
		Arg1 string  `json:"friendlyName"`
	}{intent, friendlyName}
...
func (c *waasAuthenticatorV1Client) SendIntent(ctx context.Context, intent *Intent) (string, interface{}, error) {
	in := struct {
		Arg0 *Intent `json:"intent"`
	}{intent}
	out := struct {
...
func (c *waasAuthenticatorV1Client) ChainList(ctx context.Context) ([]*Chain, error) {
	out := struct {
		Ret0 []*Chain `json:"chains"`
	}{}
