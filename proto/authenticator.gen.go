...
func WebRPCSchemaHash() string {
	return "ac3c2c244a304a00a769c89f84ff9c17c8f116bc"
}
...
type WaasAuthenticatorAdmin interface {
	...
	CreateTenant(ctx context.Context, projectId uint64, waasAccessToken string, emailEnabled bool, oidcProviders []*OpenIdProvider, allowedOrigins []string, password *string) (*Tenant, string, error)
	UpdateTenant(ctx context.Context, projectId uint64, upgradeCode string, emailEnabled bool, oidcProviders []*OpenIdProvider, allowedOrigins []string) (*Tenant, error)
}
...
func (c *waasAuthenticatorAdminClient) CreateTenant(ctx context.Context, projectId uint64, waasAccessToken string, emailEnabled bool, oidcProviders []*OpenIdProvider, allowedOrigins []string, password *string) (*Tenant, string, error) {
	in := struct {
		Arg0 uint64            `json:"projectId"`
		Arg1 string            `json:"waasAccessToken"`
		Arg2 bool              `json:"emailEnabled"`
		...
		Arg4 []string          `json:"allowedOrigins"`
		Arg5 *string           `json:"password"`
	}{projectId, waasAccessToken, emailEnabled, oidcProviders, allowedOrigins, password}
	out := struct {
		Ret0 *Tenant `json:"tenant"`
		Ret1 string  `json:"upgradeCode"`
	}{}
...
func (c *waasAuthenticatorAdminClient) UpdateTenant(ctx context.Context, projectId uint64, upgradeCode string, emailEnabled bool, oidcProviders []*OpenIdProvider, allowedOrigins []string) (*Tenant, error) {
	in := struct {
		Arg0 uint64            `json:"projectId"`
		Arg1 string            `json:"upgradeCode"`
		Arg2 bool              `json:"emailEnabled"`
		Arg3 []*OpenIdProvider `json:"oidcProviders"`
		Arg4 []string          `json:"allowedOrigins"`
	}{projectId, upgradeCode, emailEnabled, oidcProviders, allowedOrigins}
	out := struct {
		Ret0 *Tenant `json:"tenant"`
	}{}
