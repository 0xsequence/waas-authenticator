// sequence-waas-authenticator v0.1.0 9cac34a7d1a0d5cec61693997c0dba5ad98dc754
// --
// Code generated by webrpc-gen@v0.15.5 with golang@v0.14.1 generator. DO NOT EDIT.
//
// webrpc-gen -schema=authenticator.ridl -target=golang@v0.14.1 -pkg=proto -server -client -out=./authenticator.gen.go
package proto
...
func WebRPCSchemaHash() string {
	return "9cac34a7d1a0d5cec61693997c0dba5ad98dc754"
}
...
func (s *waasAuthenticatorAdminServer) serveCreateTenantJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, ret1, err := s.WaasAuthenticatorAdmin.CreateTenant(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3, reqPayload.Arg4)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
