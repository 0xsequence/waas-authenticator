// sequence-wallet v0.1.0 07bd492cff32fd23a10169cc63d324aafcf57ef2
// --
...
func WebRPCSchemaHash() string {
	return "07bd492cff32fd23a10169cc63d324aafcf57ef2"
}
...
func (c *waaSClient) DeployProjectParentWallet(ctx context.Context, projectID uint64, chainID uint64) (string, string, error) {
	in := struct {
		Arg0 uint64 `json:"projectID"`
