// sequence-wallet v0.1.0 5e1380b15b5fd1db0180e59395451d236e0b9022
// --
...
func WebRPCSchemaHash() string {
	return "5e1380b15b5fd1db0180e59395451d236e0b9022"
}
...
type Wallet interface {
	CreatePartner(ctx context.Context, projectID uint64, name string, config *PartnerWalletPreConfig, jwtAlg string, jwtSecret *string, jwtPublic *string) (*Partner, error)
	...
	SendTransaction(ctx context.Context, wallet *TargetWallet, intent *Intent, result *TransactionBundle, signatures []*ProvidedSignature) (*IntentResponse, error)
	SignMessage(ctx context.Context, wallet *TargetWallet, intent *Intent, message *SignMessage, signatures []*ProvidedSignature) (*IntentResponse, error)
	...
	SendIntent(ctx context.Context, wallet *TargetWallet, intent *Intent) (*IntentResponse, error)
...
func (c *walletClient) CreatePartner(ctx context.Context, projectID uint64, name string, config *PartnerWalletPreConfig, jwtAlg string, jwtSecret *string, jwtPublic *string) (*Partner, error) {
	in := struct {
		Arg0 uint64                  `json:"projectID"`
		Arg1 string                  `json:"name"`
		Arg2 *PartnerWalletPreConfig `json:"config"`
...
func (c *walletClient) SendTransaction(ctx context.Context, wallet *TargetWallet, intent *Intent, result *TransactionBundle, signatures []*ProvidedSignature) (*IntentResponse, error) {
	in := struct {
	...
	}{wallet, intent, result, signatures}
	out := struct {
...
func (c *walletClient) SignMessage(ctx context.Context, wallet *TargetWallet, intent *Intent, message *SignMessage, signatures []*ProvidedSignature) (*IntentResponse, error) {
	in := struct {
		Arg0 *TargetWallet        `json:"wallet"`
		Arg1 *Intent              `json:"intent"`
		Arg2 *SignMessage         `json:"message"`
		Arg3 []*ProvidedSignature `json:"signatures"`
	}{wallet, intent, message, signatures}
	out := struct {
		Ret0 *IntentResponse `json:"response"`
	}{}
...
func (c *walletClient) SendIntent(ctx context.Context, wallet *TargetWallet, intent *Intent) (*IntentResponse, error) {
	in := struct {
		Arg0 *TargetWallet `json:"wallet"`
		Arg1 *Intent       `json:"intent"`
	}{wallet, intent}
