// sequence-wallet v0.1.0 2ff18b4b1fc718871bd4092b82e62720de27ea0f
// --
...
func WebRPCSchemaHash() string {
	return "2ff18b4b1fc718871bd4092b82e62720de27ea0f"
}
...
type Wallet interface {
	...
	DeployProjectParentWallet(ctx context.Context, projectID uint64, chainID uint64) (string, string, error)
...
func (c *walletClient) CreateProject(ctx context.Context, projectID uint64, name string, config *ProjectWalletPreConfig, jwtAlg string, jwtSecret *string, jwtPublic *string) (*Project, error) {
	in := struct {
...
func (c *walletClient) ProjectParentConfig(ctx context.Context, projectID uint64) (string, error) {
	in := struct {
		Arg0 uint64 `json:"projectID"`
	}{projectID}
	out := struct {
...
func (c *walletClient) ProjectParentWallet(ctx context.Context, projectID uint64) (string, error) {
	in := struct {
		Arg0 uint64 `json:"projectID"`
	}{projectID}
	out := struct {
...
func (c *walletClient) DeployProjectParentWallet(ctx context.Context, projectID uint64, chainID uint64) (string, string, error) {
	in := struct {
		Arg0 uint64 `json:"projectID"`
...
func (c *walletClient) ProjectWallets(ctx context.Context, projectID uint64, page *Page) ([]*ProjectWallet, *Page, error) {
	in := struct {
		Arg0 uint64 `json:"projectID"`
		Arg1 *Page  `json:"page"`
	}{projectID, page}
...
func (c *walletClient) ProjectUserSalt(ctx context.Context, projectID uint64) (string, error) {
	in := struct {
		Arg0 uint64 `json:"projectID"`
	}{projectID}
	out := struct {
...
func (c *walletClient) ProjectWallet(ctx context.Context) (string, error) {
	out := struct {
		Ret0 string `json:"address"`
	}{}
...
func (c *walletClient) Wallets(ctx context.Context, page *Page) ([]*ProjectWallet, *Page, error) {
	in := struct {
		Arg0 *Page `json:"page"`
	}{page}
	out := struct {
...
func (c *walletClient) GenTransaction(ctx context.Context, intent *Intent) (*TransactionBundle, error) {
	in := struct {
...
func (c *walletClient) SendTransaction(ctx context.Context, intent *Intent, result *TransactionBundle, signatures []*ProvidedSignature) (*IntentResponse, error) {
	in := struct {
		Arg0 *Intent              `json:"intent"`
...
func (c *walletClient) SignMessage(ctx context.Context, intent *Intent, message *SignMessage, signatures []*ProvidedSignature) (*IntentResponse, error) {
	in := struct {
		Arg0 *Intent              `json:"intent"`
...
func (c *walletClient) GetSession(ctx context.Context, sessionId string) (*IntentResponse, error) {
	in := struct {
...
func (c *walletClient) RegisterSession(ctx context.Context, userID string, intent *Intent) (*IntentResponse, error) {
	in := struct {
...
func (c *walletClient) StartSessionValidation(ctx context.Context, walletAddress string, sessionId string, deviceMetadata string) (*IntentResponse, error) {
	in := struct {
		Arg0 string `json:"walletAddress"`
...
func (c *walletClient) FinishValidateSession(ctx context.Context, sessionId string, salt string, challenge string) (*IntentResponse, error) {
	in := struct {
		Arg0 string `json:"sessionId"`
...
func (c *walletClient) InvalidateSession(ctx context.Context, sessionId string) (bool, error) {
	in := struct {
		Arg0 string `json:"sessionId"`
	}{sessionId}
	out := struct {
...
func (c *walletClient) SendIntent(ctx context.Context, intent *Intent) (*IntentResponse, error) {
	in := struct {
		Arg0 *Intent `json:"intent"`
	}{intent}
	out := struct {
