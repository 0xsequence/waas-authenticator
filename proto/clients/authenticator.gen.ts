...
export const WebRPCSchemaHash = "0e207dba0750822dd4f067f67ab90fe03aec7f1e"
...
export interface WaasAuthenticator {
  registerSessionV1(args: RegisterSessionV1Args, headers?: object, signal?: AbortSignal): Promise<RegisterSessionV1Return>
  sendIntentV1(args: SendIntentV1Args, headers?: object, signal?: AbortSignal): Promise<SendIntentV1Return>
...
export interface RegisterSessionV1Args {
  intent: Intent
  friendlyName: string
}

export interface RegisterSessionV1Return {
  session: Session
  data: any  
}
export interface SendIntentV1Args {
  intent: Intent
}

export interface SendIntentV1Return {
  code: string
  data: any  
}
