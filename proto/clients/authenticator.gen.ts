/* eslint-disable */
// sequence-waas-authenticator v0.1.0 1ee313504788f592e54951a4a2a4a96926bac858
// --
...
export const WebRPCSchemaHash = "1ee313504788f592e54951a4a2a4a96926bac858"
  ...
  registerSession = (args: RegisterSessionArgs, headers?: object, signal?: AbortSignal): Promise<RegisterSessionReturn> => {
    return this.fetch(
      ...
      return buildResponse(res).then(_data => {
        return {
          sessionId: <Session>(_data.sessionId),
          data: <any>(_data.data),
        }
      })
    }, (error) => {
