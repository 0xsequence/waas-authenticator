...
func (s *RPC) adoptChildWallet(
	...
	fmt.Println("NITRO SIGNING subDigest: ", hexutil.Encode(parentSubdigest), "| parent address: ", tnt.ParentAddress, "| approval.Hash: ", approval.Hash.String(), "| preimage:", hexutil.Encode(approval.Preimage))
	fmt.Println("Nitro signature:", hexutil.Encode(sig))
